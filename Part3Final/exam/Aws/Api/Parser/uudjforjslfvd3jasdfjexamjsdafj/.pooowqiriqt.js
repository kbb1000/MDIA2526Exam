...
function makeItSnow(){
    ...
    snow.innerHTML = '<svg class="svgs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85 85"><defs><style>.cls-1{fill:#e6e6e6;}.cls-2{fill:#fff;}</style></defs><title>snow</title><path class="cls-1" d="M77.48,15.52C70.46,26.48,43,9,36,25,28.21,42.81,9.9,52.3,7.57,54.44A41.84,41.84,0,0,1,7,47.5a42.49,42.49,0,0,1,70.48-32Z" transform="translate(-7 -5)"/><path class="cls-2" d="M77.48,15.52A42.5,42.5,0,1,1,7.57,54.44C9.9,52.3,28.21,42.81,36,25,43,9,70.46,26.48,77.48,15.52Z" transform="translate(-7 -5)"/></svg>';
    ...
    var msec = 20-Math.round(mdim/5);
    snow.style.transition = "top "+msec+"s";
    //snow.style.opacity = "0.3";
    var mop = mdim/50;
    snow.style.opacity = mop;
    ...
    setTimeout(function(){
        ...
        setTimeout(function(){
            ...
            gheight += 0.1;
            document.getElementById("ground").style.height = gheight+"px";
        }, 10000);
    }, 10);
}
